$(document).ready(function () {
	...
	var wrongAnswerCount;
 		...
 		$.getJSON('json/quizbank.json', function(data) { 
...
function gameScreen(){
	$('#gameContent').empty();
	$('#gameContent').append('<div id="pixHolder"><img id="hangman" src="image/man.png"></div>');
	$('#gameContent').append('<div id="wordHolder"></div>');
	$('#gameContent').append('<div id="clueHolder"></div>');
	$('#gameContent').append('<div id="guesses">Bereits versucht:</div>');
	...
	$('#clueHolder').append("Hinweis: "+currentClue);
